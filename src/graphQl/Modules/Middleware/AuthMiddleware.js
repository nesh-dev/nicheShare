...
const authenticateMiddleware = {
  Query: addMiddlewareToResolvers([HobbyResolvers, HobbyPostResolvers, CommentResolvers], authenticate, 'Query'),
  Mutation: addMiddlewareToResolvers([HobbyResolvers, HobbyPostResolvers, CommentResolvers], authenticate, 'Mutation')
};
